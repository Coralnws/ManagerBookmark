// src/lib.rs
/*
 * Core library for ManagerBookmark
 */
...
#[derive(Debug)]
pub struct ManagerBookmarkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ManagerBookmarkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ManagerBookmark processing");
    
    let mut processor = ManagerBookmarkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ManagerBookmarkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ManagerBookmarkProcessor::new(false);
